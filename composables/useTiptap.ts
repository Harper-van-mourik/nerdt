...
export const tiptapClasses: string[] = [
  ...
  "[&_.tiptap>:not(pre)_code]:bg-slate-200 [&_.tiptap>:not(pre)_code]:rounded [&_.tiptap>:not(pre)_code]:px-2 [&_.tiptap>:not(pre)_code]:py-1 [&_.tiptap>:not(pre)_code]:text-sm",
  "[&_code]:font-xs",
  "[&_img]:rounded-xl",
  "[&_a]:underline",
  "[&_strong]:font-bold",
